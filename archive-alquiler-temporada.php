			...
			<div class="col-12 blog-loop">
				<div class="row column justify-content-center apartamentos-loop">
					...
					?>
							...
							<div class="card <?php if (($i % 2) == 1) {
													echo "col-lg-10 col-md-11 col-12";
												} else {
													echo 'col-lg-10 offset-lg-2 col-md-11 offset-md-1 col-12';
												} ?>">
								<article id="post-<?php echo $id; ?>" class="row d-flex flex-row<?php if (($i % 2) == 1) {
																									echo "-reverse";
																								} ?>">
									<?php
									// Check rows exists.
										...
										<div id="carouselapartamentos-<?php echo $id; ?>" class="carousel slide col-12 col-md-6 col-lg-7 ">
											<div class="carousel-indicators">
												...
												while (have_rows('fotografias', $id)) : the_row(); ?>
													...
													<button type="button" data-bs-target="#carouselapartamentos-<?php echo $id; ?>" data-bs-slide-to="<?php echo $e; ?>" class="<?php if ($e == 0) {
																																													echo 'active';
																																												} ?>" aria-current="true" aria-label="Slide <?php echo $e + 1; ?>"></button>
												<?php
													// End loop.
													$e++;
												endwhile;
